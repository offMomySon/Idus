package com.example.idus.infrastructure.exception;
...
public class ExceptionReciever {
    ...
    /**
     * 위와 같은 경우인데, ValidationException 가 발생할 때
     */
    ...
    /**
     * HttpMessageConverter.read 가 실패했을 때 발생한다
     * UUID 가 잘못 들어왔을 때 발생하는 것으로 확인
     */
